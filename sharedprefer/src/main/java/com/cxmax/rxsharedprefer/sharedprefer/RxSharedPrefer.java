...
public class RxSharedPrefer implements IRxSharedPrefer{
    ...
    @Override
    public void readAsAsyncFlowable(@NonNull final Consumer<SharedPreferences> consumer) {
        readAsFlowable()
    ...
    @Override
    public void editAsAsyncFlowable(@NonNull final Consumer<SharedPreferences.Editor> consumer) {
        editAsFlowable()
